...
ActiveRecord::Schema.define(version: 2021_07_12_151811) do
  ...
  add_foreign_key "interventions", "batteries", column: "column_id"
  add_foreign_key "interventions", "buildings"
  add_foreign_key "interventions", "columns", column: "battery_id"
